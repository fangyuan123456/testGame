...
class monitor_client_proxy {
    ...
    doConnect(delay) {
        ...
        setTimeout(function () {
            let connectCb = function () {
                self.app.logger("debug" /* loggerLevel.debug */, `${meFilename} connected to master success`);
            ...
            self.app.logger("debug" /* loggerLevel.debug */, `${meFilename} try to connect to master now`);
     ...
     */
    onClose() {
        this.app.logger("error" /* loggerLevel.error */, `${meFilename} socket closed, try to reconnect master later`);
        this.needDiff = true;
    ...
    heartbeatTimeout() {
        ...
        this.heartbeatTimeoutTimer = setTimeout(function () {
            self.app.logger("error" /* loggerLevel.error */, `${meFilename} heartbeat timeout, close the socket`);
            self.socket.close();
