...
class Application extends events_1.EventEmitter {
    constructor() {
        ...
        this.routeConfig2 = []; // route.ts  (split)
        ...
        this.serversIdMap = {}; // All user servers that are running (Dictionary format)
        this.serverInfo = {}; // The configuration of this server
        this.isDaemon = false; // Whether to run in the background
        this.env = ""; // environment
        this.serverId = ""; // Server name id, the unique identifier of the server
